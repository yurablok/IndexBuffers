...
bool utf::utf8CharToUcs2Char(const char* utf8Tok, wchar_t* ucs2Char, uint32_t* utf8TokLen)
{
...
void utf::ucs2CharToUtf8Char(const wchar_t ucs2Char, char* utf8Tok)
{
    //We do math, that relies on unsigned data types
...
std::wstring utf::utf8ToUcs2(const std::string& utf8Str)
{
...
std::string utf::ucs2ToUtf8(const std::wstring& ucs2Str)
{
